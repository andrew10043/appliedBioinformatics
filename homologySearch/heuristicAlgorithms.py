# Random Reference Sequence Selection (baseline)
# Select a random % of reference sequences to align the query sequences against
...
results = heuristic_local_alignment_search_random(currentQueries,
                                                  refDB, p=0.10)

for q in currentQueries:
    qID = q.metadata['id']
    print('Closest taxonomies for query ' + str(qID) + ":")
    for e in results['reference taxonomy'][qID]:
        print(' ', e)
